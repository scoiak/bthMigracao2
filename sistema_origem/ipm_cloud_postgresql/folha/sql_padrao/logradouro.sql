...
select
	...
	left(l.lognome,50) as descricao,
	null as cep,
...
where not exists (select id_gerado from public.controle_migracao_registro where hash_chave_dsk = md5(concat('300', 'logradouro', descricao, cast(municipio as varchar))))
