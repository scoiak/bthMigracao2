...
and  (select id_gerado from public.controle_migracao_registro	where hash_chave_dsk = md5(concat('300','dependencia',cpf_dependente, cpf_responsavel, datainiciobeneficio))) is null