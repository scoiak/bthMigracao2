...
def busca_dados(params_exec):
    ...
    for item in registros:
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, params_exec.get('entidade'), item['matricula']['id'], item['anoExercicio'])
        registros_formatados.append({
            'sistema': sistema,
            'tipo_registro': tipo_registro,
            'hash_chave_dsk': hash_chaves,
            'descricao_tipo_registro': 'Cadastro do Periodo Aquisitovo de Decimo Terceiro',
            'id_gerado': item['id'],
