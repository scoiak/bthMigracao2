...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['entidade'], item['descricao'], item['codigoesocial'])
        dict_dados = {
        ...
        lista_controle_migracao.append({
            ...
            'tipo_registro': tipo_registro,
            'hash_chave_dsk': hash_chaves,
            'descricao_tipo_registro': 'Cadastro da Categoria do Trabalhador',
            'id_gerado': None,
