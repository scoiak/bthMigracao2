...
sistema = 300
tipo_registro = 'calculo-folha-mensal'
url = 'https://pessoal.cloud.betha.com.br/service-layer/v1/api/calculo-folha-mensal'
limite_lote = 1000
    ...
    for item in registros:
        for matricula in item['calculoFolhaMatriculas']:
            ...
            registros_formatados.append({
                ...
                'descricao_tipo_registro': 'Cadastro de Folha de Rescisao',
                'id_gerado': item['id'],
                'i_chave_dsk1': '56',
