...
sistema = 305
tipo_registro = 'processo-lote-item'
url = 'https://compras.betha.cloud/compras-services/api/exercicios/{exercicio}/processos-administrativo/{processoAdministrativoId}/lotes/{loteId}/itens'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        url_parametrizada = url.replace('{exercicio}', str(item['ano_processo']))\
                               ...
                               .replace('{loteId}', str(item['id_lote']))
        dict_dados = {
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Vinculo Item x Lote',
            'id_gerado': None,
