...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['nome_logradouro'], item['id_municipio'])
        dict_dados = {
            "idIntegracao": hash_chaves,
            "nome": item['nome_logradouro'],
            "municipio": {
        ...
        lista_controle_migracao.append({
            ...
            'i_chave_dsk1': item['nome_logradouro'],
            'i_chave_dsk2': item['id_municipio'],
        })
