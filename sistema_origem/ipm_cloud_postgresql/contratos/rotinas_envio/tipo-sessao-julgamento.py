...
sistema = 305
tipo_registro = 'tipo-sessao-julgamento'
url = 'https://compras.betha.cloud/compras-services/api/tipos-sessao-julgamento'
    ...
    try:
        for item in registros:
            ...
            registros_formatados.append({
                ...
                'descricao_tipo_registro': 'Cadastro de Tipos de Sessão de Julgamento',
                'id_gerado': item['id'],
                'i_chave_dsk1': item['descricao']
            })
        print('registros_formatados', registros_formatados)
