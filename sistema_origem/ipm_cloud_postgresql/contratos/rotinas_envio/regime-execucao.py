...
sistema = 305
tipo_registro = 'regime-execucao'
url = 'https://compras.betha.cloud/compras-services/api/regimes-execucao'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Regimes de Execução',
            'id_gerado': None,
