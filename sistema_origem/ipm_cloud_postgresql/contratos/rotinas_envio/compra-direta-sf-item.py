...
sistema = 305
tipo_registro = 'compra-direta-sf-item'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Item de SF de Compras Diretas',
            'id_gerado': None,
