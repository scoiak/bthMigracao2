...
sistema = 305
tipo_registro = 'tipo-administracao'
url = 'https://contratos.betha.cloud/contratacao-services/api/tipos-administracao'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['clitipoentidade'])
        dict_dados = {
