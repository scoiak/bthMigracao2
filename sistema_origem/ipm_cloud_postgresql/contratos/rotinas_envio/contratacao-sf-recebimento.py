...
sistema = 305
tipo_registro = 'contratacao-sf-recebimento'
url = 'https://contratos.betha.cloud/contratacao-services/api/exercicios/{exercicio}/contratacoes/{contratacaoId}/solicitacoes/{solicitacaoId}/recebimentos'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['clicodigo'],
                                              item['copano'], item['copnro'], item['separador'], item['numero'])
        ...
        dict_dados = {
            ...
            'numero': item['numero'],
            'nomeResponsavel': item['responsavel'],
            'houveDesconto': item['houve_desconto'],
            'houveRetencaoTributaria': item['houve_retencao'],
            'dataProvisoria': item['data_provisoria'],
            'dataDefinitiva': item['data_definitiva'],
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro Recebimento de SF',
            'id_gerado': None,
