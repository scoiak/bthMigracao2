...
sistema = 305
tipo_registro = 'tipo-interposicao-recurso'
url = 'https://compras.betha.cloud/compras-services/api/tipos-interposicao-recurso'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Tipos de Interposição',
            'id_gerado': None,
