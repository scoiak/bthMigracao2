...
sistema = 305
tipo_registro = 'contratacao-arp-sf-item'
url = 'https://contratos.betha.cloud/contratacao-services/api/exercicios/{exercicio}/contratacoes/{contratacaoId}/solicitacoes/{solicitacaoId}/itens'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['clicodigo'], item['ano_ata'],
                                              item['nro_ata'], item['separador'], item['ano_sf'],
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Item de SF de Contratação de Ata RP',
            'id_gerado': None,
