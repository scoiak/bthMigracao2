...
sistema = 305
tipo_registro = 'tipo-documento'
url = 'https://compras.betha.cloud/compras-services/api/tipos-documento'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            'descricao': item['nome_docto'],
            'certidao': item['certidao'],
            'tipoCertidao': {
                'valor': item['tipo_certidao']
            },
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Tipos de Documento',
            'id_gerado': None,
