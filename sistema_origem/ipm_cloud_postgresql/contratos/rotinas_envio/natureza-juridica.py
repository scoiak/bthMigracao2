...
sistema = 305
tipo_registro = 'natureza-juridica'
url = 'https://compras.betha.cloud/compras-services/api/naturezas-juridicas'
    ...
    try:
        for item in registros:
            ...
            registros_formatados.append({
                ...
                'descricao_tipo_registro': 'Cadastro de Naturezas Juridicas',
                'id_gerado': item['id'],
