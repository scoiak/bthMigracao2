...
sistema = 305
tipo_registro = 'prazo-entrega'
url = 'https://compras.betha.cloud/compras-services/api/prazos-entrega'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['id_entidade'], item['descricao'])
        dict_dados = {
            'idIntegracao': hash_chaves,
            'descricao': item['descricao'],
            'tipoExecucao': {
                'valor': item['tipo_execucao']
            },
            'unidadeEntrega': {
                'valor': item['unidade_entrega']
            },
            'numDiasMeses': item['num_dias_meses']
        }
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Prazos de Entrega',
            'id_gerado': None,
