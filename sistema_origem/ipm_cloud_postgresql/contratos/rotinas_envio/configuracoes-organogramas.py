...
url = 'https://compras.betha.cloud/compras-services/api/configuracoes-organogramas'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['ano'])
        dict_dados = {
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Configuração de Organogramas',
            'id_gerado': None,
