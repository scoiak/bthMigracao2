...
sistema = 305
tipo_registro = 'tipo-sancao'
url = 'https://contratos.betha.cloud/contratacao-services/api/tipos-sancao'
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item['sustipo'])
        dict_dados = {
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Tipos de Sanção',
            'id_gerado': None,
            'json': json.dumps(dict_dados),
            'i_chave_dsk1': item['sustipo']
        })
