...
from (
	select
		...
		c.clicodigo,
		left(c.copfinalidade, 500) as objeto,
		...
		'S' as fornecimento_imediato,
		concat('Compra direta ', c.copnro, '/', c.copano, '. ', c.cophistorico) as observacao,
		...
		709 as id_tipo_objeto, -- COMPRAS_SERVICOS
