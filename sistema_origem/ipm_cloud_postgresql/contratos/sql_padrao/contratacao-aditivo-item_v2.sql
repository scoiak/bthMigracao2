select
    1 as id,
	875981 as id_contratacao,
	(select id_gerado from public.controle_migracao_registro where hash_chave_dsk = md5(concat(305, 'contratacao-item', tab.clicodigo, tab.ano_contrato, tab.nro_contrato, '@', tab.cmiid))) as id_contratacao_item,
	57160 as id_aditivo,
	*,
	'@' as separador,
...
from (
	select
		2017 as ano_contrato,
		263 as nro_contrato, -- IDENTIFICADOR!
		q.clicodigo,
		q.minano,
		q.minnro,
		q.unicodigo,
