...
from (
	select
		...
		(select id_gerado from public.controle_migracao_registro where hash_chave_dsk = md5(concat(305, 'ata-rp', a.clicodigo, a.arpano, a.arpnro, '@', a.arpsequencia, '@', c.cmiid))) as id_contratacao_item,
		...
		(select id_gerado from public.controle_migracao_registro where hash_chave_dsk = md5(concat(305, 'contratacao-sf-item', c.clicodigo, a.arpano, a.arpnro, '@', c.copano, c.copnro, '@', c.cmiid))) as id_gerado
